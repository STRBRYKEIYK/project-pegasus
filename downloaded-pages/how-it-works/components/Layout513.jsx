          ...
          <div className="flex flex-col gap-y-16 md:sticky md:top-20 md:mt-20 md:h-[calc(100vh_-10rem)] md:justify-center">
            <div className="flex flex-col">
              ...
              <h2 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                Eight steps from zero to running
              </h2>
              <p className="md:text-md">
                Connect your product, set your rules, and let the system handle
                the rest. Each step is built for speed and accuracy.
              </p>
              ...
              <AnimatePresence>
                <Fragment>
                  <ConditionalRender condition={render.isMobile}>
                    <div>
                      ...
                      <p>
                        Set commission rates, payout schedules, and refund
                        clawback policies without writing code.
                      </p>
                      <div className="mt-4">
                        <img
                          src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image-1.svg"
                ...
                <Fragment>
                  <ConditionalRender condition={render.isMobile}>
                    <div>
                      <h5 className="mb-3 text-xl font-bold">
                        03 Invite affiliates
                      </h5>
                      <p>
                        Affiliates use the AI campaign builder to create emails,
                        landing pages, and social posts in seconds.
                      </p>
                      <div className="mt-4">
                        <img
                          src="https://d22po4pjz3o32e.cloudfront.net/placeholder-image-3.svg"
