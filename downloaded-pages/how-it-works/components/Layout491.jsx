    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Creation</p>
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            AI builds campaigns affiliates actually want to run
          </h1>
          <p className="md:text-md">
            Your affiliates don't write. They choose. The system generates email
            sequences, landing pages, and social copy in seconds, then they
            customize for their voice. Brand safety controls keep everything
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Each template is tested against real affiliate performance
                  data. Affiliates start with proven angles, not blank pages.
                  They edit, not create from scratch.
                </p>
              </motion.div>
            </div>
            <div
