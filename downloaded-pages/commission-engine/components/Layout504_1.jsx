        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="md:text-md">
              Every commission earned, every clawback applied, every payout
              sent. The ledger records it all with timestamps and reasons. You
              and your affiliates see the same truth.
            </p>
          ...
          >
            <div className="grid grid-cols-1 border border-border-primary md:grid-cols-2 md:items-center">
              ...
              <div className="p-6 md:p-8 lg:p-12">
                <p className="mb-3 font-semibold md:mb-4">Immutable</p>
                <h2 className="mb-5 text-4xl font-bold leading-[1.2] md:mb-6 md:text-5xl lg:text-6xl">
                  Audit logs that cannot be altered
                </h2>
                <p>
                  Once a transaction is recorded, it stays. No deletions, no
                  edits. This is how you prove to your affiliates and auditors
