    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Generate</p>
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Create landing pages in minutes
          </h1>
          <p className="md:text-md">
            Feed the builder your product details and brand voice. The AI
            generates a working landing page draft with headlines, copy blocks,
            and call-to-action buttons. You review, edit, and publish.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Build multi-part email campaigns that guide prospects from
                  awareness to purchase. The AI structures the sequence, writes
                  each message, and times the sends.
                </p>
              </motion.div>
            </div>
            <div
