      ...
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Build campaigns together without the chaos
          </h1>
          <p className="md:text-md">
            Your team and affiliates work in the same builder. Comments,
            suggestions, and version history keep everyone aligned. No more
            email chains or lost edits.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Multiple users edit the same campaign at the same time. See
                  cursor positions, watch changes happen live, and avoid
