    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          <p className="mb-3 font-semibold md:mb-4">Payouts</p>
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Commissions that compound, refunds that clawback
          </h1>
          <p className="md:text-md">
            Recurring revenue means recurring commissions. Your affiliates earn
            on every renewal, every upgrade. Refunds automatically reverse their
            payout. No disputes, no manual adjustments.
          </p>
          ...
          <div className="relative grid auto-cols-fr grid-cols-1 grid-rows-[auto_auto] items-start md:items-stretch">
            ...
            >
              <h2 className="text-2xl font-bold md:text-3xl md:leading-[1.3] lg:text-4xl">
                Recurring commissions tracked live
              </h2>
              <motion.div
                initial={false}
              ...
              >
                <p className="mt-3 md:mt-4">
                  An affiliate brings in a customer who stays for twelve months.
                  They earn twelve months of commissions. The ledger updates in
                  real time as renewals hit.
                </p>
              </motion.div>
            </div>
            <div
