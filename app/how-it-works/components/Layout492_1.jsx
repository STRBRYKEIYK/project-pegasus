      ...
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Taxes and payouts handled automatically
          </h1>
          <p className="md:text-md">
            Tax forms are collected during onboarding. Payouts are triggered by
            your rules. The system files what it needs to file. You stay
            compliant without the work.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  W-9s, W-8BENs, or local equivalents are gathered during
                  affiliate signup. No last-minute scrambling. No missing
                  paperwork at payout time.
                </p>
              </motion.div>
            </div>
            <div
