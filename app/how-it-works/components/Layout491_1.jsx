      ...
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Every dollar is visible, every transaction logged
          </h1>
          <p className="md:text-md">
            Your affiliates see their wallet balance. You see theirs. Every
            transaction is timestamped and immutable. Trust is built on ledgers,
            not promises.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Affiliates log in and see exactly what they've earned, what's
                  pending, and what's been paid. No guessing. No waiting for
                  spreadsheets.
                </p>
              </motion.div>
            </div>
