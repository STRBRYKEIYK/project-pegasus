        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="md:text-md">
              Fraud detection flags click farms and invalid traffic. AI content
              checks ensure quality. Role-based access and GDPR/CCPA compliance
              protect everyone. Enterprise audit trails prove legitimacy to
              regulators.
            </p>
          ...
          >
            <div className="grid grid-cols-1 border border-border-primary md:grid-cols-2 md:items-center">
              <div className="p-6 md:p-8 lg:p-12">
                <p className="mb-3 font-semibold md:mb-4">Detection</p>
                <h2 className="mb-5 text-4xl font-bold leading-[1.2] md:mb-6 md:text-5xl lg:text-6xl">
                  Fraud detection and prevention
                </h2>
                <p>
                  Suspicious patterns trigger alerts. You set thresholds.
                  Flagged commissions hold pending your review before payout.
                </p>
