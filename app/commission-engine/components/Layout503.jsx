      ...
      <div className="container">
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            <p className="mb-3 font-semibold md:mb-4">Clawback</p>
            <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
              Refunds handled automatically
            </h1>
            <p className="md:text-md">
              A customer cancels or requests a refund. The system claws back the
              commission instantly, no manual work. Disputes get resolved
              through a transparent audit trail that both you and your
              affiliates can see.
            </p>
            ...
            <div className="grid grid-cols-1 border border-border-primary md:grid-cols-2 md:items-center">
              <div className="p-6 md:p-8 lg:p-12">
                ...
                <h2 className="mb-5 text-4xl font-bold leading-[1.2] md:mb-6 md:text-5xl lg:text-6xl">
                  Commission reversal when refunds occur
                </h2>
                <p>
                  The moment a refund processes, the affiliated commission is
                  reversed. No grace period, no exceptions. Your affiliates see
                  it happen in real time on their ledger.
                </p>
