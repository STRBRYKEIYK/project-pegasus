      ...
      <div className="container">
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            <p className="mb-3 font-semibold md:mb-4">Engine</p>
            <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
              How commissions actually work
            </h1>
            <p className="md:text-md">
              Every affiliate sale flows through our ledger system. You set the
              rules, the system enforces them without exception.
            </p>
          ...
          >
            <div className="grid grid-cols-1 border border-border-primary md:grid-cols-2 md:items-center">
              ...
              <div className="p-6 md:p-8 lg:p-12">
                <p className="mb-3 font-semibold md:mb-4">Recurring</p>
                <h2 className="mb-5 text-4xl font-bold leading-[1.2] md:mb-6 md:text-5xl lg:text-6xl">
                  Commissions paid every billing cycle
                </h2>
                <p>
                  Your affiliates earn on every renewal. When a customer stays,
                  the commission stays. No guessing, no disputes about what was
                  owed.
                </p>
