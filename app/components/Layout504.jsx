        ...
        <div className="mb-12 md:mb-18 lg:mb-20">
          <div className="mx-auto max-w-lg text-center">
            ...
            <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
              Commission engine that handles it all
            </h1>
            <p className="md:text-md">
              One-time sales, recurring revenue, MLM structures, refund
              clawbacks. The system calculates what each affiliate owes and what
              you owe them. No disputes. No guessing.
            </p>
          ...
          >
            <div className="grid grid-cols-1 border border-border-primary md:grid-cols-2 md:items-center">
              ...
              <div className="p-6 md:p-8 lg:p-12">
                <p className="mb-3 font-semibold md:mb-4">Single</p>
                <h2 className="mb-5 text-4xl font-bold leading-[1.2] md:mb-6 md:text-5xl lg:text-6xl">
                  Pay affiliates once per sale
                </h2>
                <p>
                  Set a flat rate or percentage. Payout triggers on conversion.
                  Clean and simple.
                </p>
