      ...
      <div className="container">
        <div className="mx-auto mb-12 max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <h1 className="mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Payouts and tax compliance built in
          </h1>
          <p className="md:text-md">
            Automated payouts to any payment method. Tax forms collected and
            filed. Compliance workflows that scale with your program.
          </p>
            ...
            >
              ...
              >
                <p className="mt-3 md:mt-4">
                  Set a schedule. The system pays affiliates on time, every
                  time. ACH, wire, PayPal, or crypto. Your choice.
                </p>
              </motion.div>
            </div>
            <div
